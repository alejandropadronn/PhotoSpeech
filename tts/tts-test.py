...
tts = gTTS(text='Pepperoni Pizza', lang='en') # set Text,Language, and speed settings here (can be set to speak slower)
filename = '/tmp/temp.mp3' # temporary storage locaction for the .mp3 file
tts.save(filename) # saves the file with the indicated name, in our case 'filename' is the name we've chosen to give our file.
